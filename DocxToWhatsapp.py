...
- remove some word at the beginning of lines starting with "N°" and replace with emoji's numbers
...
def open_file():
    ...
    name = askopenfilename(
        initialdir="D:\\Users\\Yassine\\OneDrive\\Islam\\Teaching\\Adabul Mufrad\\Chapitres",
...
def get_docx_text(path):
    ...
    paragraphs.append("")
    paragraphs.append(
        "_Qu’Allah SWT nous accorde le véritable amour pour le Prophèteﷺ et qu'il nous aide à "
        "mettre en pratique ses précieux conseils._ *Amine*")
    paragraphs.append("")
